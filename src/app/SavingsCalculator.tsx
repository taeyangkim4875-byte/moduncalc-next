  ...
  return (
    <>
      ...
      <Card>
        ...
        <p className="text-sm text-[#4E5968] leading-relaxed">적금 만기 때 얼마 받는지 세금 떼고 계산해드려요. 청년도약계좌(5년)와 미래적금(3년)을 한번에 비교할 수 있어요.</p>
      </Card>
      ...
      <Card>
        ...
        <div className="flex flex-col gap-4">
          <div>
            <div className="text-sm font-bold text-[var(--ink)] mb-1">Q. 중도해지하면 어떻게 되나요?</div>
            <div className="text-sm text-[#4E5968] leading-relaxed">A. 정부 기여금을 돌려줘야 하고, 이자에 15.4% 과세돼요. 만기까지 유지하는 게 유리해요.</div>
          </div>
          <div>
            <div className="text-sm font-bold text-[var(--ink)] mb-1">Q. 정부 기여금이란?</div>
            <div className="text-sm text-[#4E5968] leading-relaxed">A. 납입액에 비례해서 정부가 추가로 넣어주는 돈이에요. 소득이 낮을수록 매칭 비율이 높아요.</div>
          </div>
        </div>
      </Card>
