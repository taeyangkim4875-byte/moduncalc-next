...
export default function TransferTaxCalc() {
  ...
  return (<>
    <Card>
      ...
      <div className="mb-4">
        ...
        <div className="flex items-center gap-2.5">
          <input type="number" value={acqPrice} min={0} onChange={e => setAcqPrice(+e.target.value)} className="flex-1 py-3 px-3.5 border-[1.5px] border-[var(--line)] rounded-xl text-base font-bold outline-none focus:border-[var(--primary)]" />
      ...
      <div className="mb-4">
        ...
        <div className="flex items-center gap-2.5">
          <input type="number" value={sellPrice} min={0} onChange={e => setSellPrice(+e.target.value)} className="flex-1 py-3 px-3.5 border-[1.5px] border-[var(--line)] rounded-xl text-base font-bold outline-none focus:border-[var(--primary)]" />
          <span className="text-sm font-bold text-[var(--sub)]">만원</span>
        </div>
      </div>
      <div className="mb-4">
    ...
    <Card>
      ...
      <p className="text-sm text-[#4E5968] leading-relaxed">양도세 얼마 나오는지 매수가랑 매도가 넣으면 바로 나와요. 보유기간, 1주택 여부에 따라 크게 달라져요.</p>
    </Card>

    <Card>
      <h2 className="text-base font-extrabold mb-3">자주 묻는 질문</h2>
      <div className="flex flex-col gap-4">
        <div><div className="text-sm font-bold text-[var(--ink)] mb-1">Q. 1세대1주택 비과세 조건은?</div><div className="text-sm text-[#4E5968] leading-relaxed">A. 12억 이하면 전액 비과세예요. 2년 이상 보유 필수이고, 조정대상지역은 2년 거주도 필요해요.</div></div>
        <div><div className="text-sm font-bold text-[var(--ink)] mb-1">Q. 1년 미만 보유하면 세율이 높나요?</div><div className="text-sm text-[#4E5968] leading-relaxed">A. 네, 1년 미만은 45% 단일세율이에요. 장기 보유가 절세에 유리합니다.</div></div>
      </div>
    </Card>
