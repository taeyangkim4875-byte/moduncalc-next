...
export default function CommissionCalc() {
  ...
  return (<>
    ...
    <Card>
      ...
      <p className="text-sm text-[#4E5968] leading-relaxed">복비가 얼마인지 미리 알아두면 부동산에서 바가지 안 써요. 법정 상한요율 기준으로 계산해드려요.</p>
    </Card>

    <Card>
      <h2 className="text-base font-extrabold mb-3">자주 묻는 질문</h2>
      <div className="flex flex-col gap-4">
        <div><div className="text-sm font-bold text-[var(--ink)] mb-1">Q. 복비를 깎을 수 있나요?</div><div className="text-sm text-[#4E5968] leading-relaxed">A. 네, 상한요율 범위 안에서 협의 가능해요. 계약 전에 수수료를 미리 확인하세요.</div></div>
        <div><div className="text-sm font-bold text-[var(--ink)] mb-1">Q. 부가세는 별도인가요?</div><div className="text-sm text-[#4E5968] leading-relaxed">A. 일반과세자인 중개사는 10% 부가세가 별도예요. 간이과세자면 면제되거나 줄어들 수 있어요.</div></div>
      </div>
    </Card>
