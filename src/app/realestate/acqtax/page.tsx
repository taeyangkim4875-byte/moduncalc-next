...
export const metadata: Metadata = { title: "취득세 계산기 - 주택 매매 취득세·농특세·교육세", description: "주택 매매 시 납부할 취득세, 농어촌특별세, 지방교육세를 계산하세요.", alternates: { canonical: "https://moduncalc.com/realestate/acqtax" }, openGraph: { title: "취득세 계산기 - 주택 매매 취득세·농특세·교육세 (2026)", description: "주택 매매가와 주택 수를 입력하면 취득세·농어촌특별세·지방교육세를 자동 계산. 다주택 중과세율 반영.", url: "https://moduncalc.com/realestate/acqtax" } };
