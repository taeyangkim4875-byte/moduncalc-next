...
export const metadata: Metadata = { title: "DSR 계산기 - 대출 한도 확인 · 총부채원리금상환비율 (2026)", description: "연소득과 기존 대출로 DSR을 계산하고 대출 가능 한도를 확인하세요. 40% / 50% / 60% 규제 기준 반영.", alternates: { canonical: "https://moduncalc.com/loan/dsr" } };
