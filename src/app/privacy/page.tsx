    ...
    <PageLayout eyebrow="법적 고지" title="개인정보처리방침" description="모든 계산기의 개인정보 처리에 관한 안내입니다.">
      <Card>
        <div className="text-sm text-[#4E5968] leading-[1.8]">
          ...
          <h2 className="text-[17px] font-extrabold text-[var(--ink)] mt-7 mb-2.5">5. 개인정보의 보유 및 파기</h2>
          <p>서비스는 개인정보를 직접 수집·보유하지 않습니다. Google Analytics 및 AdSense를 통해 수집되는 데이터는 Google의 데이터 보유 정책에 따릅니다.</p>

          <h2 className="text-[17px] font-extrabold text-[var(--ink)] mt-7 mb-2.5">6. 이용자의 권리</h2>
          <ul className="pl-5 my-2 list-disc">
          ...
          <h2 className="text-[17px] font-extrabold text-[var(--ink)] mt-7 mb-2.5">7. 개인정보 보호책임자</h2>
          <p>이름: 김태양<br/>이메일: taeyang.kim4875@gmail.com</p>

          <h2 className="text-[17px] font-extrabold text-[var(--ink)] mt-7 mb-2.5">8. 방침 변경</h2>
