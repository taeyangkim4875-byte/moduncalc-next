...
export const metadata: Metadata = { title: "할인가 계산기 - 할인율·1+1 단가 비교", description: "할인율 적용가와 1+1, 2+1 단가를 비교하세요.", robots: { index: false, follow: false }, alternates: { canonical: "https://moduncalc.com/daily/discount" } };
