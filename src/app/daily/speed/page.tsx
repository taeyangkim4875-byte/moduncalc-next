...
export const metadata: Metadata = { title: "속도·시간 계산기 - 소요시간·속도변환", description: "거리와 속도로 소요 시간을 계산하세요.", robots: { index: false, follow: false }, alternates: { canonical: "https://moduncalc.com/daily/speed" } };
