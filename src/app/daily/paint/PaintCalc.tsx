...
export default function PaintCalc(){
  ...
  return(<>
    ...
    <Card>
      ...
      <p className="text-sm text-[#4E5968] leading-relaxed">방 크기 넣으면 페인트 몇 리터, 벽지 몇 롤 필요한지 알려드려요. 예상 비용도 같이 나와요.</p>
    </Card>
    <Card>
      <h2 className="text-base font-extrabold mb-3">자주 묻는 질문</h2>
      <div className="flex flex-col gap-4">
        <div><div className="text-sm font-bold text-[var(--ink)] mb-1">Q. 페인트 1L로 몇 m&sup2;를 칠할 수 있나요?</div><div className="text-sm text-[#4E5968] leading-relaxed">A. 보통 1L당 약 10m&sup2;예요. 벽면 상태에 따라 달라질 수 있어서 여유분을 두는 게 좋아요.</div></div>
        <div><div className="text-sm font-bold text-[var(--ink)] mb-1">Q. 왜 2회 도포가 필요한가요?</div><div className="text-sm text-[#4E5968] leading-relaxed">A. 1회만 칠하면 기존 색이 비치거나 얼룩이 생겨요. 2회 도포하면 색이 균일하고 내구성도 좋아져요.</div></div>
      </div>
    </Card>
