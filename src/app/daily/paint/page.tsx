...
export const metadata: Metadata = { title: "페인트 벽지 계산기 - 방 면적에 필요한 자재량 계산", description: "방 크기를 입력하면 필요한 페인트량(L)과 벽지 롤 수를 자동 계산. 셀프 인테리어 필수 도구.", robots: { index: false, follow: false }, alternates: { canonical: "https://moduncalc.com/daily/paint" } };
