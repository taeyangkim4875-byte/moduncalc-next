...
export const metadata: Metadata = { title: "평수 계산기 - 평↔㎡(제곱미터) 변환 · 부동산 면적 환산", description: "평수와 제곱미터(㎡)를 상호 변환합니다. 1평 = 3.3058㎡. 전용면적, 공급면적, 계약면적 차이도 설명.", alternates: { canonical: "https://moduncalc.com/daily/pyeong" } };
