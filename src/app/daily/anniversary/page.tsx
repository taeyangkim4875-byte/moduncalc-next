...
export const metadata: Metadata = { title: "기념일 계산기 - 연애 100일·200일·1000일 자동 계산", description: "사귄 날짜를 입력하면 100일, 200일, 300일, 500일, 1000일 기념일을 자동 계산합니다.", robots: { index: false, follow: false }, alternates: { canonical: "https://moduncalc.com/daily/anniversary" } };
