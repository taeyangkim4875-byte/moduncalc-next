...
export const metadata: Metadata = { title: "아기 100일 계산기 - 백일·돌·기념일 자동 계산", description: "아기 생년월일을 입력하면 100일, 200일, 돌, 주요 기념일을 자동 계산합니다.", robots: { index: false, follow: false }, alternates: { canonical: "https://moduncalc.com/daily/baby100" } };
