  ...
  return (
    <>
      ...
      <Card>
        ...
        <p className="text-sm text-[#4E5968] leading-relaxed">자동차세 얼마 나오는지 배기량이랑 연식 넣으면 바로 나와요. 연납하면 4.58% 할인돼요. 전기차는 연 13만원 고정이에요.</p>
      </Card>
      ...
      <Card>
        ...
        <div className="flex flex-col gap-4">
          <div>
            <div className="text-sm font-bold text-[var(--ink)] mb-1">Q. 연납 신청은 어떻게 하나요?</div>
            <div className="text-sm text-[#4E5968] leading-relaxed">A. 위택스(wetax.go.kr)에서 1월에 신청하면 약 4.58% 할인돼요. 한 번 신청하면 매년 자동 적용됩니다.</div>
          </div>
          <div>
            <div className="text-sm font-bold text-[var(--ink)] mb-1">Q. 전기차 자동차세는 얼마인가요?</div>
            <div className="text-sm text-[#4E5968] leading-relaxed">A. 연 10만원 + 지방교육세 3만원 = 연 13만원 고정이에요.</div>
          </div>
        </div>
      </Card>
