...
export const metadata: Metadata = { title: "자동차세 계산기 - 2026 배기량·연식별 자동차세 계산", description: "차량 배기량과 연식으로 연간 자동차세를 자동 계산합니다. 비영업용 승용차 기준. 경감률 반영.", alternates: { canonical: "https://moduncalc.com/daily/cartax" } };
