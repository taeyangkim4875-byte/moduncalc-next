...
export default function AgeCalc(){
  ...
  return(<>
    ...
    <Card>
      ...
      <p className="text-sm text-[#4E5968] leading-relaxed">생년월일만 넣으면 만 나이, 한국 나이, 띠, 별자리 다 나와요. 2023년 6월부터 법적으로도 만 나이가 기준이에요.</p>
    </Card>
    <Card>
      <h2 className="text-base font-extrabold mb-3">자주 묻는 질문</h2>
      <div className="flex flex-col gap-4">
        <div><div className="text-sm font-bold text-[var(--ink)] mb-1">Q. 만 나이가 법적 기준인가요?</div><div className="text-sm text-[#4E5968] leading-relaxed">A. 네, 2023년 6월 28일부터 민법·행정법에서 만 나이를 기준으로 사용합니다.</div></div>
        <div><div className="text-sm font-bold text-[var(--ink)] mb-1">Q. 띠는 어떻게 정해지나요?</div><div className="text-sm text-[#4E5968] leading-relaxed">A. 출생 연도를 12로 나눈 나머지로 결정돼요. 쥐부터 돼지까지 12년 주기로 반복됩니다.</div></div>
      </div>
    </Card>
  </>);
}
