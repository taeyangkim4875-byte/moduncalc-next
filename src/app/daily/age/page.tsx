...
export const metadata: Metadata = { title: "나이 계산기 - 만 나이·한국 나이·띠·별자리", description: "나는 만 몇 살? 생년월일 입력하면 만 나이·한국 나이·띠·별자리 한번에 확인.", alternates: { canonical: "https://moduncalc.com/daily/age" } };
