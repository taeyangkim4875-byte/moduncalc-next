...
export const metadata: Metadata = { title: "음주 후 운전 가능 시간 계산기 - 혈중알코올 분해 시간", description: "술 마신 후 운전 가능한 시간을 계산하세요. 음주량, 체중, 성별 기반 혈중알코올농도 추정 및 분해 시간 계산.", alternates: { canonical: "https://moduncalc.com/daily/alcohol" } };
