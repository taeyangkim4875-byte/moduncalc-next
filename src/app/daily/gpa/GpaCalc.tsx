...
export default function GpaCalc() {
  ...
  return (<>
    ...
    <Card>
      ...
      <p className="text-sm text-[#4E5968] leading-relaxed">학점 평균 계산할 때 과목별로 넣으면 바로 나와요. 4.5 만점 기준이에요.</p>
    </Card>

    <Card>
      <h2 className="text-base font-extrabold mb-3">자주 묻는 질문</h2>
      <div className="flex flex-col gap-4">
        <div><div className="text-sm font-bold text-[var(--ink)] mb-1">Q. 4.5 만점과 4.3 만점의 차이는?</div><div className="text-sm text-[#4E5968] leading-relaxed">A. 대부분의 한국 대학은 4.5 만점(A+=4.5)을 쓰고, 서울대 등 일부는 4.3 만점을 적용해요.</div></div>
        <div><div className="text-sm font-bold text-[var(--ink)] mb-1">Q. 재수강하면 성적이 어떻게 반영되나요?</div><div className="text-sm text-[#4E5968] leading-relaxed">A. 이전 성적이 새 성적으로 대체되지만, 재수강 상한(예: A0까지만)이 있는 학교가 많아요.</div></div>
      </div>
    </Card>
  </>);
}
