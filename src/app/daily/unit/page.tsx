...
export const metadata: Metadata = { title: "단위 변환기 - 길이·무게·온도·면적", description: "1인치는 몇 cm? 1파운드는 몇 kg? 길이·무게·온도·면적 단위 변환 한번에.", robots: { index: false, follow: false }, alternates: { canonical: "https://moduncalc.com/daily/unit" } };
