...
export const metadata: Metadata = { title: "음력 양력 변환기 - 음력 양력 날짜 변환 (2026)", description: "음력 날짜를 양력으로, 양력 날짜를 음력으로 변환하세요. 설날, 추석, 음력 생일 양력 날짜 확인.", robots: { index: false, follow: false }, alternates: { canonical: "https://moduncalc.com/daily/lunar" } };
