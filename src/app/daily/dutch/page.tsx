...
export const metadata: Metadata = { title: "더치페이 계산기 - N분의1·팁 계산", description: "N분의1 금액과 팁을 빠르게 계산하세요.", robots: { index: false, follow: false }, alternates: { canonical: "https://moduncalc.com/daily/dutch" } };
