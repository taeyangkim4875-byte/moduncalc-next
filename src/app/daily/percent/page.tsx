...
export const metadata: Metadata = { title: "퍼센트 계산기 - 비율·변화율 계산", description: "비율, 변화율, 할인율을 빠르게 계산해요.", robots: { index: false, follow: false }, alternates: { canonical: "https://moduncalc.com/daily/percent" } };
