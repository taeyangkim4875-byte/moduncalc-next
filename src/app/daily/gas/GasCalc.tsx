  ...
  return (
    <>
      ...
      <Card>
        ...
        <p className="text-sm text-[#4E5968] leading-relaxed">겨울 난방비 얼마 나올지 궁금하면 사용량 넣어보세요. 기본료 + 사용료 + 부가세 구조로 계산해드려요.</p>
      </Card>

      <Card>
        <h2 className="text-base font-extrabold mb-3">자주 묻는 질문</h2>
        <div className="flex flex-col gap-4">
          <div><div className="text-sm font-bold text-[var(--ink)] mb-1">Q. 열량환산계수란?</div><div className="text-sm text-[#4E5968] leading-relaxed">A. 가스 1㎥당 발생하는 열량(MJ)이에요. 가스 고지서에서 확인할 수 있어요.</div></div>
          <div><div className="text-sm font-bold text-[var(--ink)] mb-1">Q. 겨울 난방비가 갑자기 많이 나온 이유는?</div><div className="text-sm text-[#4E5968] leading-relaxed">A. 사용량 증가에 열량환산계수도 올라가서 이중으로 요금이 높아져요.</div></div>
        </div>
      </Card>
