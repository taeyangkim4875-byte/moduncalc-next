...
export const metadata: Metadata = { title: "도시가스 요금 계산기 - 난방비 · 가스비 자동 계산 (2026)", description: "월 도시가스 사용량으로 가스요금을 계산하세요. 난방용·취사용 구분, MJ 기준 요금 자동 계산.", robots: { index: false, follow: false }, alternates: { canonical: "https://moduncalc.com/daily/gas" } };
