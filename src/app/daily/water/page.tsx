...
export const metadata: Metadata = { title: "수도요금 계산기 - 2026 가정용 수도요금 자동 계산", description: "월 사용량으로 수도요금을 계산하세요. 상수도 + 하수도 + 물이용부담금 포함.", robots: { index: false, follow: false }, alternates: { canonical: "https://moduncalc.com/daily/water" } };
