  ...
  if (purpose === 'work') {
    ...
    if (koreanLevel === 'topik5' && (duration === 'long' || duration === 'permanent')) {
      return {
        ...
        workAllowed: 'Yes, unrestricted',
        requirements: [
          'Points-based system: need 80+ points (common items total 130)',
          'Categories: age (25), education (25), Korean ability (20), income (60)',
          'TOPIK 5+ or KIIP Stage 5 gives the full 20 language points, but is not mandatory',
          'Income is the heaviest category — roughly 1.5x GNI per capita expected',
