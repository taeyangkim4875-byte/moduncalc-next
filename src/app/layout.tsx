...
export const metadata: Metadata = {
  title: {
    default: "모든 계산기 - 연봉, 적금, 대출, 건강, 세금 무료 계산기 82종 (2026)",
    template: "%s | 모든 계산기",
  },
  description: "연봉 실수령액, 청년도약계좌, 청년미래적금, 대출이자, 취득세, BMI, 퇴직금, 최저시급까지. 2026년 최신 정책 반영 무료 계산기 모음 82종.",
  ...
  verification: {
    google: "2CSZ2hOaOD4k58f3xV-XFFPRM7ri_eSkXfObfhdUQ9w",
    other: {
