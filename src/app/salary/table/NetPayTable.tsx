  ...
  return (
    <>
      ...
      <Card>
        ...
        <p className="text-sm text-[#4E5968] leading-relaxed">연봉별 실수령액을 표로 한눈에 비교할 수 있어요. 연봉 협상 전에 꼭 확인해보세요.</p>
      </Card>
      <Card>
        <h2 className="text-base font-extrabold mb-3">자주 묻는 질문</h2>
        <div className="flex flex-col gap-4">
          <div><div className="text-sm font-bold text-[var(--ink)] mb-1">Q. 내 연봉 구간은 어떻게 찾나요?</div><div className="text-sm text-[#4E5968] leading-relaxed">A. 각 행을 터치하면 상세 공제 내역을 볼 수 있어요. 하이라이트된 행이 주요 연봉 구간이에요.</div></div>
          <div><div className="text-sm font-bold text-[var(--ink)] mb-1">Q. 부양가족이 많으면 달라지나요?</div><div className="text-sm text-[#4E5968] leading-relaxed">A. 이 표는 부양가족 1명 기준이에요. 부양가족이 많으면 소득세가 줄어서 실수령액이 올라가요.</div></div>
        </div>
      </Card>
    </>
  );
