...
export const metadata: Metadata = { title: "연차 계산기 - 입사일 기준 연차 일수 자동 계산", description: "내 연차 며칠 남았을까? 입사일만 입력하면 발생 연차·잔여 연차 바로 확인. 근로기준법 기준.", alternates: { canonical: "https://moduncalc.com/salary/annual" } };
