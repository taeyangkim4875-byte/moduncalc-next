...
export default function SeveranceCalc() {
  ...
  return (<>
    ...
    <Card>
      ...
      <p className="text-sm text-[#4E5968] leading-relaxed">퇴직금 못 받을까봐 걱정되면 여기서 미리 계산해보세요. 1년 이상 일했으면 무조건 받을 수 있어요.</p>
    </Card>

    <Card>
      <h2 className="text-base font-extrabold mb-3">자주 묻는 질문</h2>
      <div className="flex flex-col gap-4">
        <div><div className="text-sm font-bold text-[var(--ink)] mb-1">Q. 1년 미만이면 퇴직금 못 받나요?</div><div className="text-sm text-[#4E5968] leading-relaxed">A. 법적으로는 1년 이상이어야 하지만, 회사 내규에 따라 지급하는 곳도 있으니 취업규칙을 확인해보세요.</div></div>
        <div><div className="text-sm font-bold text-[var(--ink)] mb-1">Q. 퇴직금에 세금이 붙나요?</div><div className="text-sm text-[#4E5968] leading-relaxed">A. 퇴직소득세가 부과되지만 보통 2~10% 수준이에요. IRP로 받으면 30~40% 감면도 가능하거든요.</div></div>
      </div>
    </Card>
