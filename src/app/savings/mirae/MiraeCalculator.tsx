...
const BANKS: BankRate[] = [
  { name: 'KB국민', group: 1, maxBonus: 3.0, items: [
    { label: '소득우대', rate: 0.5, desc: '총급여 3,600만원 이하' },
    { label: '재무상담', rate: 0.2, desc: '청년 재무상담 이수' },
    { label: '급여이체', rate: 0.5, desc: '급여이체 실적 18개월 이상' },
    { label: '카드이용', rate: 0.8, desc: '공과금/카드 이용 월 12회 이상' },
    { label: '첫적금/연계', rate: 0.5, desc: '첫 적금 또는 도약계좌 연계' },
    { label: '마케팅동의', rate: 0.5, desc: '마케팅 수신 동의' },
  ]},
  { name: 'NH농협', group: 1, maxBonus: 3.0, items: [
    { label: '소득우대', rate: 0.5, desc: '총급여 3,600만원 이하' },
    { label: '재무상담', rate: 0.2, desc: '청년 재무상담 이수' },
    { label: '급여이체', rate: 0.8, desc: '급여이체 실적' },
    { label: '카드이용', rate: 0.7, desc: '카드 실적 월 20만원 이상' },
    { label: '첫적금/연계', rate: 0.5, desc: '첫 적금 또는 도약계좌 연계' },
    { label: '마케팅동의', rate: 0.3, desc: '마케팅 수신 동의' },
  ]},
  { name: '신한', group: 1, maxBonus: 3.0, items: [
    { label: '소득우대', rate: 0.5, desc: '총급여 3,600만원 이하' },
    { label: '재무상담', rate: 0.2, desc: '청년 재무상담 이수' },
    { label: '급여이체', rate: 0.3, desc: '급여이체 18개월 이상' },
    { label: '카드이용', rate: 0.2, desc: '신한카드 18개월 이상 이용' },
    { label: '첫적금/연계', rate: 0.3, desc: '첫 적금 또는 도약 연계' },
    { label: '증권거래', rate: 0.5, desc: '신한투자증권 3개월 거래' },
    { label: '특별우대', rate: 1.0, desc: '도약계좌 연계가입 시 (한정)' },
  ]},
  { name: '하나', group: 1, maxBonus: 3.0, items: [
    { label: '소득우대', rate: 0.5, desc: '총급여 3,600만원 이하 또는 소득플러스' },
    { label: '재무상담', rate: 0.2, desc: '청년 재무상담 이수' },
    { label: '급여이체', rate: 1.2, desc: '급여 또는 가맹점대금 이체' },
    { label: '카드이용', rate: 0.6, desc: '하나카드 결제 24회 이상' },
    { label: '목돈마련', rate: 0.5, desc: '목돈 마련 응원' },
  ]},
  { name: '우리', group: 1, maxBonus: 3.0, items: [
    { label: '소득입금', rate: 1.5, desc: '소득 입금 시' },
    { label: '연계가입', rate: 0.5, desc: '예적금 미보유 또는 연계가입' },
    { label: '카드/공과금', rate: 0.5, desc: '카드·공과금 자동이체' },
    { label: '출시기념', rate: 0.3, desc: '출시 기념 우대 (한정)' },
    { label: '재무상담', rate: 0.2, desc: '청년 재무상담 이수' },
  ]},
  { name: '기업', group: 1, maxBonus: 3.0, items: [
    { label: '소득우대', rate: 0.5, desc: '총급여 3,600만원 이하' },
    { label: '재무상담', rate: 0.2, desc: '청년 재무상담 이수' },
    { label: '급여이체', rate: 0.8, desc: '급여이체 실적' },
    { label: '카드이용', rate: 0.5, desc: 'IBK카드 이용' },
    { label: '연계가입', rate: 0.5, desc: '도약계좌 연계 또는 첫 적금' },
    { label: '기타', rate: 0.5, desc: '마케팅 동의 등' },
  ]},
  { name: '우체국', group: 1, maxBonus: 3.0, items: [
    { label: '소득우대', rate: 0.5, desc: '총급여 3,600만원 이하' },
    { label: '재무상담', rate: 0.2, desc: '청년 재무상담 이수' },
    { label: '급여이체', rate: 0.8, desc: '급여이체 실적' },
    { label: '기타', rate: 1.5, desc: '우체국 거래실적 등' },
  ]},
  { name: '카카오뱅크', group: 2, maxBonus: 2.0, items: [
    { label: '소득우대', rate: 0.5, desc: '총급여 3,600만원 이하' },
    { label: '재무상담', rate: 0.2, desc: '청년 재무상담 이수' },
    { label: '급여이체', rate: 0.5, desc: '급여이체 실적' },
    { label: '기타', rate: 0.8, desc: '카카오뱅크 거래 실적' },
  ]},
];
