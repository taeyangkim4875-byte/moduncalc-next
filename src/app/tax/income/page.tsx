...
export const metadata: Metadata = { title: "종합소득세 계산기 - 2026 누진세율", description: "종합소득세 누진세율을 적용한 예상 세액을 계산하세요.", alternates: { canonical: "https://moduncalc.com/tax/income" }, openGraph: { title: "종합소득세 계산기 - 2026 누진세율 8구간 자동 계산", description: "과세표준 입력하면 소득세·지방소득세를 8구간 누진세율로 자동 계산. 인적공제, 실효세율 확인.", url: "https://moduncalc.com/tax/income" } };
