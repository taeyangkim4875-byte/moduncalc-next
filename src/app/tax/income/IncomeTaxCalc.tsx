...
export default function IncomeTaxCalc(){
  ...
  return(<>
    ...
    <Card>
      ...
      <p className="text-sm text-[#4E5968] leading-relaxed">종합소득세가 얼마 나올지 궁금하면 여기서 바로 확인하세요. 6~45% 누진세율 적용이에요.</p>
    </Card>
    <Card>
      <h2 className="text-base font-extrabold mb-3">자주 묻는 질문</h2>
      <div className="flex flex-col gap-4">
        <div><div className="text-sm font-bold text-[var(--ink)] mb-1">Q. 세율은 어떻게 되나요?</div><div className="text-sm text-[#4E5968] leading-relaxed">A. 6%(1,400만원 이하)~45%(10억 초과)의 누진세율이에요. 지방소득세 10% 별도예요.</div></div>
        <div><div className="text-sm font-bold text-[var(--ink)] mb-1">Q. 인적공제란?</div><div className="text-sm text-[#4E5968] leading-relaxed">A. 본인·배우자·부양가족 1인당 150만원을 소득에서 빼주는 제도예요.</div></div>
      </div>
    </Card>
