...
export const metadata: Metadata = { title: "BMI 계산기 - 체질량지수·비만도 판정", description: "키·체중만 입력하면 BMI + 비만도 판정 바로 확인. WHO 아시아태평양 기준. 정상 범위와 개선 방법까지.", alternates: { canonical: "https://moduncalc.com/health/bmi" } };
