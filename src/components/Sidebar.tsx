...
const MENUS_EN: MenuItem[] = [
  ...
  { href: '/en/guide/tax-guide', ico: '📖', label: 'Guides', sub: [
    ...
    { label: 'First 90 Days', href: '/en/guide/first-90-days' },
    { label: 'ARC Guide', href: '/en/guide/arc-guide' },
    { label: 'Renting Apartment', href: '/en/guide/apartment-guide' },
    { label: 'Korean Food', href: '/en/guide/korean-food-guide' },
    { label: 'Transportation', href: '/en/guide/transportation-guide' },
